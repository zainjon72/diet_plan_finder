    ...
    <header id="header" class="header-area style-01 layout-01">
        ...
        <div class="header-middle biolife-sticky-object ">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                        <a href="index-2.html" class="biolife-logo"><img src="{{ asset('assets2/images/organic-3.png') }}" alt="biolife logo" width="135" height="34"></a>
                    </div>
                            ...
                            <ul class="products-list">
                                ...
                                <li class="product-item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                    <div class="contain-product layout-default">
                                        <div class="product-thumb">
                                            <a href="#" class="link-to-product">
                                                <img src="{{ url('/storage/app/public/'.$plan->image) }}" alt="dd" width="270" height="270" class="product-thumnail">
                                            </a>
                                        </div>
                                        <div class="info">
                                            {{-- <b class="categories">Fresh Fruit</b> --}}
                                            ...
                                            <div class="shipping-info">
                                                <p class="shipping-day">Diet Plans</p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-9">
                        <section class="footer-item">
                            <a href="#" class="logo footer-logo"><img src="{{ asset('/assets2/images/organic-3.png') }}" alt="biolife logo" width="135" height="34"></a>
