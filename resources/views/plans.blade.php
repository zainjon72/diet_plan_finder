...
<div class="shell">
  <div class="container">
    <div class="row">
      ...
      <div class="col-4 p_card" style="display: inline-block; margin: auto;padding: 10px;margin-bottom: 150px;margin: 30px 50px 100px 30px !important;">
...
<h1 class="view_plan"><a href="{{ url('/plans') }}">View Plans</a></h1>
@endif
{{-- </div>  --}}
