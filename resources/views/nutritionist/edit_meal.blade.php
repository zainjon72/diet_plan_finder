            ...
            <div class="row">
               <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mx-auto ">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title text-center">Update {{ $page_title }}</h3>
                                    <!-- <p>Use custom button styles for actions in forms, dialogs, and more with support for multiple sizes, states, and more.</p> -->
                                </div>
                                <div class="card">
                                    <!-- <h5 class="card-header">Basic Form</h5> -->
                                    <div class="card-body">
                                        <form method="post" action="{{ url('/nutritionist/update_meal/'.$id) }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Title</label>
                                                <input name="title" id="inputText3" type="text" class="form-control" value="{{ $meal['title'] }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputEmail">Discription</label>
                                                <textarea rows="8" name="discription" id="inputEmail" type="text" placeholder="" class="form-control">{{ $meal['discription'] }}</textarea>
                                            ...
                                            <button type="submit" class="btn btn-primary btn-block"> Update {{ $page_title }}</button>
                                            </div>
                                        </form>
                                    </div>
