                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" data-action="delete_record"  href="{{url('/nutritionist/delete_plan/'.$plans['id']) }}" data-url="" >Delete</a> 
                                                            {{-- <a class="dropdown-item" href="{{url('/nutritionist/approve/'.$plans['id'])}}"> Approve </a> --}}
                                                            <a class="dropdown-item" href="{{url('/nutritionist/edit_plan/'.$plans['id'])}}"> Edit </a>
                                                        </div>
                                                    </div>
                                                </td>
                                                {{-- <td>
