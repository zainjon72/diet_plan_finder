                  ...
                  <div class="row">
                     <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mx-auto ">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="post" action="{{ url('/nutritionist/edit_plan/'.$id) }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="inputText3" class="col-form-label">Title</label>
                                        <input required="" name="title" id="inputText3" type="text" class="form-control" value="{{ $plans['title'] }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail">Discription</label>
                                        <textarea required="" rows="8" name="discription" id="inputEmail" type="text" placeholder="" class="form-control">{{ $plans['discription'] }}</textarea>

                                    </div>
                                    <div class="form-group">
                                        <label for="inputText3" class="col-form-label">Price</label>
                                        <input required="" name="price" id="inputText3" type="number" class="form-control" value="{{ $plans['price'] }}">
                                    </div>
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <select name="meals[]" class="select2" multiple placeholder="Choose skills" data-allow-clear="1">
