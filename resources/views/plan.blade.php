        ...
        <div id="main-content" class="main-content">
            ...
            <div class="meals">
                <table class="table table-striped table-hover table-dark ">
                    ...
                    @if($plan->id == $order_item['diet_plan_id'])
                    ...
                    <tr>
                        <td>{{$meal_one->title}}</td>
                        <td><img style="width: 100px;" src="{{ url('/storage/app/public/'.$meal_one->image) }}" alt=""></td>
                        <td>{{ $meal_one->discription }}</td>
                        {{-- <td></td> --}}
                    </tr>
                    @endif
                    @endforeach
