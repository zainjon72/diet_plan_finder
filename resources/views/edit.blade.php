                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6 mx-auto">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Update Health Conditions</h6>
                            <form method="post" action="{{ url('/admin/edit/'.$id) }}">
                                @csrf
                                <div class="mb-3">

                                    <label for="exampleInputEmail1" class="form-label">Title</label>
                                    <input value="{{ $healthcondition['title'] }}" type="text" name="title" class="form-control" id="exampleInputEmail1"
