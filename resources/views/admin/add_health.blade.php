            ...
            <div class="row">
               <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mx-auto ">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title text-center">Add Health Conditions</h3>
                                    <!-- <p>Use custom button styles for actions in forms, dialogs, and more with support for multiple sizes, states, and more.</p> -->
                                </div>
                                <div class="card">
                                    <!-- <h5 class="card-header">Basic Form</h5> -->
                                    <div class="card-body">
                                        <form method="post" action="{{ url('/admin/health') }}">
                                            @csrf
                                            ...
                                            <button type="submit" class="btn btn-primary btn-block"> Add Health Condition</button>
                                            </div>
                                        </form>
                                    </div>
