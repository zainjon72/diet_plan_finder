        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-finance">
                <div class="container-fluid dashboard-content">
                    ...
                    <a type="button" class="btn btn-primary my-3" href="{{ url('/admin/health') }}">
            ...
            <div class="row">
               <div class="col-xl-6 col-lg-6 col-md-8 col-sm-12 col-12 mx-auto">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title text-center">Edit Health Conditions</h3>
                                    <!-- <p>Use custom button styles for actions in forms, dialogs, and more with support for multiple sizes, states, and more.</p> -->
                                </div>
                                <div class="card">
                                    <!-- <h5 class="card-header">Basic Form</h5> -->
                                    <div class="card-body">
                                        <form method="post" action="{{ url('/admin/edit_health/'.$id) }}">
                                            @csrf
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Title</label>
                                                <input name="title" id="inputText3" type="text" class="form-control" value="{{ $health_condition['title'] }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="inputEmail">Discription</label>
                                                <textarea rows="8" name="discription" id="inputEmail" type="text" placeholder="" class="form-control">{{ $health_condition['discription'] }}</textarea>
                                                
                                            </div>
                                            <div class="form-control">
                                            <button type="submit" class="btn btn-primary btn-block"> Edit Health Condition</button>
                                            </div>
                                        </form>
                                    </div>
