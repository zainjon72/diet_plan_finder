        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-finance">
                <div class="container-fluid dashboard-content">
                    ...
                    <a type="button" class="btn btn-primary my-3" href="{{ url('/admin/add_health') }}">
                      Add New
                  </a>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $health_condition->discription }}</td>


                                        <td>

                                          <a class="btn btn-primary" href="{{url('/admin/delete_health/'.$health_condition['id'])}}"> Delete </a>
                                      </td>

                                      <td>
                                         <a type="button" class="btn btn-primary my-3" href="{{url('/admin/edit_health/'.$health_condition['id'])}}">
                                          Edit
                                      </a>
                                  </td>
